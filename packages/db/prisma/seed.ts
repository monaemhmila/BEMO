...
async function main() {
  ...
  const DEFAULT_TEMPLATES = [
      ...
      },
      {
        ...
        description: "An exciting trip through outer space exploring planets and cultural diversity.",
        ageRange: "6-8",
        category: "science" as const,
        prompts: {
          theme: "blasts off in a rocket ship and meets friendly aliens",
          moralLesson: "Inclusion, celebrating differences, and cosmic curiosity",
          educationalFocus: "Solar system astronomy, gravity, planets & physics basics",
        },
        tags: ["space", "aliens", "stars", "astronomy", "inclusion"],
        isActive: true,
      },
      {
        id: "bedtime-dream",
      ...
      },
      {
        id: "superhero-day",
        name: "Superhero Day",
        description: "Discovering that true strength comes from helping others and good deeds.",
        ageRange: "6-8",
        category: "fantasy" as const,
        prompts: {
          theme: "wakes up with super powers and saves the day",
          moralLesson: "Integrity, community responsibility & standing up for good",
          educationalFocus: "Civic duties, safety awareness & cause-and-effect reasoning",
        },
        tags: ["superhero", "powers", "brave", "integrity", "community"],
        isActive: true,
      },
      {
        id: "ocean-adventure",
        name: "Under the Sea",
        description: "Diving underwater to explore marine life and protect ocean reefs.",
        ageRange: "3-5",
        category: "fantasy" as const,
        prompts: {
          theme: "dives under the ocean and discovers a mermaid kingdom",
          moralLesson: "Ocean preservation, teamwork & keeping waters clean",
          educationalFocus: "Marine biology, coral reefs & recycling concepts",
        },
        tags: ["ocean", "mermaids", "underwater", "marine biology", "cleanliness"],
        isActive: true,
      },
    ];
